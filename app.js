...
formulario.addEventListener('submit', (e) =>{
    ...
    if(isNaN(textCedula.value)){
        ...
        validateCedula(textCedula.value) ? 
        message(`La Cédula ${textCedula.value} es valida`, `alert-success`) :
        message(`La Cédula ${textCedula.value} no es valida`, `alert-danger`)
    }
})
